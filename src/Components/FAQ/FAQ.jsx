...
const FAQ = () => {
    return (
        <div className="m-8">
            ...
            <div className="collapse collapse-arrow bg-slate-400 mt-12 border-4 text-white">
            ...
            <div className="collapse collapse-arrow bg-slate-400 mt-4 border-4 text-white">
